# Run CODEX AGENT CLI on Android 

This guide shows you how to run the **CODEX Coding Agent CLI** on your Android device using [Termux](https://f-droid.org/en/packages/com.termux/) and a proot Ubuntu environment.
...
You can install CODEX using this following NPM command :
...
That's it — codex CLI is now running inside your Ubuntu environment on Termux! 🎉
