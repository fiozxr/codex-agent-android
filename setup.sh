...
#
# setup.sh — Automated installer for CODEX Coding Agent CLI on Termux
# Sets up a proot Ubuntu environment, installs Node.js and CODEX CLI,
# and configures auto-login into Ubuntu on every Termux launch.
#
# Usage:
#   curl -fsSL https://raw.githubusercontent.com/fiozxr/codex-agent-android/main/setup.sh | bash
#

set -e  # Exit immediately if a command fails

echo "=================================================="
echo "  CODEX CLI Setup — Termux + Ubuntu (proot-distro)"
echo "=================================================="
echo ""
...
if ! grep -q "proot-distro login ubuntu" "$BASHRC"; then
    {
        echo ""
        echo "# Auto-login into Ubuntu (added by codex CLI setup.sh)"
        echo "clear"
...
# ---------------------------------------------------------
# Step 4: Log into Ubuntu and install Node.js + CODEX CLI
# ---------------------------------------------------------
echo "[5/5] Entering Ubuntu to install Node.js and CODEX CLI..."
...
proot-distro login ubuntu -- bash -c "
    ...
    echo '--- Installing CODEX Coding Agent CLI ---'
...
echo "      codex"
echo ""
echo "  to start the codex Coding Agent."
echo "=================================================="
